...
Connect-VIServer -Server "be-vce-bib.fbisp.eu" -Credential (Get-Credential "spimi\U390207") -ea Stop
Connect-VIServer -Server "bib-vcentar-02.deltabank.co.yu" -Credential (Get-Credential) -ea Stop
...
$clusters = "CITRIX-PR","CITRIX-ST","TYPE2","FLEX-PR","SATELLITE-ST"
